...
{
    public class BioportalAnnoDataElement
    {
        //注释后的class
        string bioportalAnnoClass;
        //注释后的本体名称
        string bioportalAnnoOntology;
        //注释后的原文本
        //string medportalAnnoContxt;
        //注释以后的IRI
        string bioportalAnnoIRI;
        //本体名称
        //string medportalAnnoOntologyName;

        public string BioportalAnnoClass { get => bioportalAnnoClass; set => bioportalAnnoClass = value; }
        public string BioportalAnnoOntology { get => bioportalAnnoOntology; set => bioportalAnnoOntology = value; }
        //public string MedportalAnnoContxt { get => medportalAnnoContxt; set => medportalAnnoContxt = value; }
        public string BioportalAnnoIRI { get => bioportalAnnoIRI; set => bioportalAnnoIRI = value; }
