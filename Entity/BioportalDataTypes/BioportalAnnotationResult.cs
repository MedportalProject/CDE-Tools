...
{
    class BioportalAnnotationResult
    {
        [JsonProperty("annotatedClass")]
        public BioportalAnnotatedClass AnnotatedClass { get; set; }
        [JsonProperty("hierarchy")]
        public List<BioportalAnnotatedClass> Hierarchy { get; set; }
        [JsonProperty("annotations")]
        public List<BioportalAnnotation> Annotations { get; set; }
