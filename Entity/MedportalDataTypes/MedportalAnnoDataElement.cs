...
{
    public class MedportalAnnoDataElement
    {
        //注释后的class
        string medportalAnnoClass;
        //注释后的本体名称
        string medportalAnnoOntology;
        //注释后的原文本
        //string medportalAnnoContxt;
        //注释以后的IRI
        string medportalAnnoIRI;
        //本体名称
        //string medportalAnnoOntologyName;

        public string MedportalAnnoClass { get => medportalAnnoClass; set => medportalAnnoClass = value; }
        public string MedportalAnnoOntology { get => medportalAnnoOntology; set => medportalAnnoOntology = value; }
        //public string MedportalAnnoContxt { get => medportalAnnoContxt; set => medportalAnnoContxt = value; }
        public string MedportalAnnoIRI { get => medportalAnnoIRI; set => medportalAnnoIRI = value; }
        //public string MedportalAnnoOntologyName { get => medportalAnnoOntologyName; set => medportalAnnoOntologyName = value; }
    }
}
