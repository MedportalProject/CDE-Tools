...
{
    public class MedportalAnnotationResult
    {
        [JsonProperty("annotatedClass")]
        public MedportalAnnotatedClass AnnotatedClass { get; set; }
        [JsonProperty("hierarchy")]
        public List<MedportalAnnotatedClass> Hierarchy { get; set; }
        [JsonProperty("annotations")]
        public List<MedportalAnnotation> Annotations { get; set; }
