...
namespace CDETools.Entity.Medporal
{
    public static class MedporalNetwork
    {
        public static string GetJsonResponse(string url)
        {
            HttpClient web = new HttpClient();
            # please replace your own medportal apikey
            web.DefaultRequestHeaders.Add("Authorization", "apikey token=YOUR OWN MEDPORTAL APIKEY");
